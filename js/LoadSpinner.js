...
function LoadSpinner(radius, time, baseColor, strokeColor, centerX, centerY) {
...
LoadSpinner.prototype.draw = function (ctx) {
	...
	var strokeSize = this.circle.radius/20;
	...
	ctx.arc(this.circle.centerX,this.circle.centerY,this.circle.radius, 0, 2 * Math.PI, false);
	ctx.fill();
	...
	ctx.arc(this.circle.centerX,this.circle.centerY,this.circle.radius - strokeSize*.5, -Math.PI*.5, 2 * Math.PI * arcDecimal - Math.PI * .5, true);
	ctx.stroke();
	...
	ctx.arc(this.circle.centerX,this.circle.centerY,this.circle.radius - strokeSize*.5, -Math.PI*.5, 2 * Math.PI * arcDecimal - Math.PI * .5, false);
	ctx.stroke();
